    ...
    return (
        <MarketingLayout nav>
            ...
            <article className="max-w-3xl mx-auto px-6 py-16 md:py-24">
                ...
                <h1 className="text-3xl md:text-4xl font-semibold text-surface-900 mb-10">{title}</h1>

                <div className="space-y-10">
                    {sections.map((section) => (
                        <section key={section.heading}>
                            <h2 className="text-lg font-semibold text-surface-900 mb-3">{section.heading}</h2>
                            <p className="text-surface-600 leading-relaxed whitespace-pre-line">{section.body}</p>
                        </section>
                    ))}
                </div>
            </article>
